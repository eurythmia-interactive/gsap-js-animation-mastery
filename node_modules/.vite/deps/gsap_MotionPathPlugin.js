import { o as getGlobalMatrix } from "./matrix-CLbkHbOg.js";
//#region part-2/node_modules/gsap/utils/paths.js
/*!
* paths 3.14.2
* https://gsap.com
*
...
*/
var _svgPathExp = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, _numbersExp = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, _scientific = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, _selectorExp = /(^[#\.][a-z]|[a-y][a-z])/i, _DEG2RAD$1 = Math.PI / 180, _RAD2DEG = 180 / Math.PI, _sin = Math.sin, _cos = Math.cos, _abs = Math.abs, _sqrt = Math.sqrt, _atan2 = Math.atan2, _largeNum = 1e8, _isString = function _isString(value) {
...
function getPositionOnPath(rawPath, progress, includeAngle, point) {
	...
	if (includeAngle) result.angle = segment.totalLength ? getRotationAtBezierT(segment, i, t >= 1 ? .999999999 : t ? t : 1e-9) : segment.angle || 0;
	return result;
}
...
//#endregion
//#region part-2/node_modules/gsap/MotionPathPlugin.js
/*!
...
var _xProps = "x,translateX,left,marginLeft,xPercent".split(","), _yProps = "y,translateY,top,marginTop,yPercent".split(","), _DEG2RAD = Math.PI / 180, gsap, PropTween, _getUnit, _toArray, _getStyleSaver, _reverting, _getGSAP = function _getGSAP() {
	...
	if (align) if (align === "self" || (alignTarget = _toArray(align)[0] || target) === target) transformRawPath(rawPath, 1, 0, 0, 1, curX - x, curY - y);
	else {
